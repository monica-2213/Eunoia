package com.example.eunoia.ToDoList.Adapter;
...
import com.example.eunoia.CreateNew;
...
public class ToDoAdapter extends RecyclerView.Adapter<ToDoAdapter.MyViewHolder> {
    ...
    private CreateNew activity;
    private DataBaseHelper myDB;

    public ToDoAdapter(DataBaseHelper myDB, CreateNew activity){
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        ...
        holder.mCheckBox.setText(item.getTaskName()+"\n"+item.getTaskDesc());
    ...
    public void editItem(int position){
        ...
        bundle.putString("tdesc",item.getTaskDesc());
